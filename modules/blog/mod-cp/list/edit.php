...
global $ACL;
if (!$ACL->hasPermission('blog_add') || !$ACL->hasPermission('blog_edit')) {
    error403();
    die;
}
global $Route;
...
?>
    <div class="card card-info IRANSans">
        <div class="card-body">
            ...
            echo div_start('col-6');
?>
                <div><?php echo __("categories") ?></div>
                <hr/>
                <?php

            \Joonika\Modules\Blog\categoryCheckboxParentHTML("blog_category",0, 0,$dataID);
...
' . ajax_validate([
        ...
        "validate" => true,
        "prevent" => true,
        "url" => JK_DOMAIN_LANG . 'cp/blog/list/add',
