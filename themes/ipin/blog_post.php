    ...
    <div class="row">
        ...
        <div class="row ">
            <div class="card col-12 flex-md-row mb-4 shadow-sm h-md-250 post-standard">
                <img class="card-img-right flex-auto d-none d-lg-block" src="/<?php echo $thumbnail; ?>" alt="<?php echo $data['title']; ?>">
                <div class="card-body d-flex flex-column align-items-md-start align-items-center">
                    ...
                    <div class="meta-out col-12">
                        <ul class="meta ">
                            <li><span class="fa fa-calendar"></span> <?php echo \Joonika\Idate\date_int("d F Y",$data['datetime']); ?></li>
<!--                            <li><span class="icon icon_comment_alt"></span> <span class="text-muted">تعداد بازدید: </span>--><?php //echo $data['views']; ?><!--</li>-->
                        </ul>
                    </div>
